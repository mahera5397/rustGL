...
////    }
////
////    pub fn get_color(&self,mut kx:f32,ky:f32,reverse:bool)->TGAColor{
...
////
////        let final_x=if !reverse{
////            (x_on_middle+x_offset) as usize}
////        else { (x_on_last+x_offset) as usize };
////
////        self.texture.get_pixel(final_x,y)
////    }
////
////    pub fn get_color_by_coef(&self,kx:f32,ky:f32)->TGAColor{
////        let y=self.min_y+(ky*self.height as f32) as usize;
////        let x =self.min_x+(kx*self.width as f32) as usize;
